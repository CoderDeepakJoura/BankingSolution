...
const categories: VoucherCategory[] = [
  {
    ...
    vouchers: [
      ...
      },
      {
        ...
        description: "Calculate and post saving account interest",
  ...
  },
  {
    ...
    vouchers: [
      ...
      {
        label: "FD Interest Posting",
        description: "Post cumulative interest to FD interest payable account",
        path: "/fd-interest-posting",
        icon: <TrendingUp size={26} className="text-amber-600" />,
        color: "bg-amber-50 border-amber-200",
      },
      {
        label: "MIS Interest Posting",
        description: "Post monthly MIS interest to member saving accounts",
        path: "/mis-interest-posting",
        icon: <TrendingUp size={26} className="text-violet-600" />,
        color: "bg-violet-50 border-violet-200",
      },
    ],
  },
  {
    ...
    vouchers: [
      ...
      {
        label: "RD Multiple Kist",
        description: "Post kist payments for multiple RD accounts in one voucher",
        path: "/rd-multiple-kist-voucher",
      ...
      {
        label: "RD Interest Posting",
        description: "Post periodic interest to recurring deposit accounts",
  ...
  },
  {
    ...
    vouchers: [
      ...
      {
        label: "Loan Expense Stand",
        description: "Record a loan-related expense with optional GST details",
        path: "/loan-expense",
        icon: <Banknote size={26} className="text-yellow-600" />,
