...
class thanaApiService extends ApiService {
  ...
  async fetchthanas(
    ...
    return this.makeRequest<thanaResponse>(
      `/thana/get_all_thanas/${branchId}`,
      {
        method: "POST",
  ...
  async getAllThanas(branchId: number): Promise<ApiResponse<thanaResponse>> {
    return this.makeRequest<thanaResponse>(`/fetchdata/get_all_thanas`, {
      method: "POST",
