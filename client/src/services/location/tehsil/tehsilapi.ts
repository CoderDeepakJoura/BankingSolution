...
class tehsilApiService extends ApiService {
  ...
  async fetchtehsils(
    ...
    return this.makeRequest<tehsilResponse>(
      `/tehsil/get_all_tehsils/${branchId}`,
      {
        method: "POST",
  ...
  async getAllTehsils(branchId: number): Promise<ApiResponse<tehsilResponse>> {
    return this.makeRequest<tehsilResponse>(`/fetchdata/get_all_tehsils`, {
      method: "POST",
