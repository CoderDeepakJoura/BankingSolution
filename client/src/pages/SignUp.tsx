...
const SignUp = () => {
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    // TODO: Send sign up data to backend API
  ...
  return (
     <div className="relative min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
      ...
      {/* Main Content */}
      <main className="relative z-10 flex-grow flex items-center justify-center p-6 min-h-[calc(100vh-140px)]">
          ...
          <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
            ...
            <div className="px-8 pt-8 pb-6 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
              <div className="text-center">
                ...
                <p className="text-blue-100 text-sm">Start your journey with SecureBank</p>
              </div>
            </div>

            {/* Sign Up Form */}
            <form onSubmit={handleSignUp} className="px-8 py-8 space-y-6">
              {/* Fullname */}
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg className="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5.121 17.804A9.001 9.001 0 1112 21a9.001 9.001 0 01-6.879-3.196z" />
                    </svg>
                  </div>
                  <input
                    id="fullname"
                  ...
                  >
                    {showPassword ? (
                      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L8.464 8.464M9.878 9.878l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0L9.878 9.878m7.532 7.532L21 21" />
                      </svg>
                    ) : (
                      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              {/* Confirm Password */}
              <div className="space-y-2">
                <label htmlFor="confPassword" className="block text-sm font-semibold text-gray-700">
                  Confirm Password
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
              ...
              <div className="mt-6 p-4 bg-amber-50 border border-amber-200 rounded-xl">
                <div className="flex items-start space-x-3">
                  ...
                  <div className="text-sm text-amber-800">
                    ...
                    <p>Always ensure you're on the official SecureBank domain. Never share your credentials via email or phone.</p>
                  </div>
                </div>
              </div>
            </form>
