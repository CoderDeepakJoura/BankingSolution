...
const buildPrintHTML = (data: LoanLedger, longNar: boolean): string => {
  ...
  <div class="summary">
    ...
    <div class="summary-card" style="border-top-color:#ef4444"><div class="lbl">Total Advancement / Interest</div><div class="val" style="color:#b91c1c">₹${fmt(data.totalDr)}</div></div>
