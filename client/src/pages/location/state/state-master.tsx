...
import StateApiService from "../../../services/location/state/stateapi";
...
const StateMaster: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await StateApiService.createState(stateName, stateCode);
      ...
      if (response.success) {
        ...
        Swal.fire({
          icon: "error",
          title: "Error!",
          text: response.message || "Failed to save state.",
        });
      }
    } catch (err: any) {
      Swal.fire({
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mt-1 text-sm sm:text-base">Create and manage state configurations</p>
                  </div>
                </div>
                <button
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-b border-gray-200 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Create New State</h2>
                    <p className="text-sm text-gray-600">Fill in the state details below</p>
                  </div>
                </div>
              </div>
              ...
              <form className="p-6 sm:p-8" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="stateName" className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                    ...
                    <p className="text-xs text-gray-500 flex items-center gap-1 mt-1">
                      <FaInfoCircle />
                      Descriptive name for the state (max 50 characters)
                    </p>
                  </div>
                  {/* State Code Field */}
                  <div className="flex flex-col">
                    <label htmlFor="stateCode" className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
