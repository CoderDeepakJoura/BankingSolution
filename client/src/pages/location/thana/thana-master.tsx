...
const ThanaMaster: React.FC = () => {
  ...
  const handleReset = () => {
    ...
    setError("");
    setLoading(false);
    const ThanaName = document.getElementById("ThanaName") as HTMLInputElement;
    ThanaName.focus();
  };
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await ThanaApiService.add_new_thana(
        ThanaName,
        ThanaCode,
        ThanaNameSL || "",
        user.branchid
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Fill in the Thana details below
                    </p>
                  </div>
                </div>
              </div>
