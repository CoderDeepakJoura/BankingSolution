...
const CategoryMaster: React.FC = () => {
  ...
  const handleCategoryNameSLChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    const inputText = e.target.value;
    if (inputText === "" || hindiRegex.test(inputText)) {
      setCategoryNameSL(inputText);
      setError("");
    } else {
          ...
          <div className="max-w-7xl mx-auto space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 sm:p-8">
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <button
                  onClick={() => navigate("/Category-operations")}
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-purple-50 border-b border-gray-200 p-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h2 className="text-lg sm:text-xl font-semibold text-gray-800">Create New Category</h2>
              ...
              <form className="p-6 sm:p-8" onSubmit={handleSubmit}>
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2">
                  ...
                  <div className="flex flex-col">
                    <label htmlFor="CategoryName" className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                    ...
                    <p className="text-xs text-gray-500 flex items-center gap-1 mt-1">
                      <FaInfoCircle />
                      Descriptive name for the Category (max 50 characters)
                    </p>
                  </div>

                  {/* Category Name SL Field */}
                  <div className="flex flex-col">
                    <label htmlFor="CategoryNameSL" className="flex items-center gap-2 text-sm font-semibold text-gray-700 mb-2">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        type="text"
                        id="CategoryNameSL"
                        value={CategoryNameSL}
                        onChange={handleCategoryNameSLChange}
                        maxLength={50}
                        ...
                        placeholder="Enter Category name in Hindi/Devanagari"
                        lang="hi"
                      />
                    </div>
                    {error ? (
